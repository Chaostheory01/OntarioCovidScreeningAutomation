...
namespace CovidScreeningApp
{
    class Program
    {
        ...
        {   
            ...
            await ExecuteActionAndPause(() => webDriver.Navigate().GoToUrl(@"https://covid-19.ontario.ca/self-assessment/"));
            await ExecuteActionAndPause(() => webDriver.FindElement(By.XPath(@"//button[text()='Start self-assessment']")).Click());
            ...
            await ExecuteActionAndPause(() => webDriver.FindElement(By.XPath(@"//button[text()='No']")).Click());
            await ExecuteActionAndPause(() => webDriver.FindElement(By.XPath(@"//button[text()='No']")).Click());
            await ExecuteActionAndPause(() => webDriver.FindElement(By.XPath(@"//button[text()='Save self-assessment result (PDF)']")).Click());
